...
function StyleFilter({setstyleIsOpen, settypeIsOpen, setsearchIsOpen, setcountOnPageIsOpen, styleIsOpen, setTypedData, setFilteredData, typedData}){
    ...
    return (
        <div>
             <div className={classes["select-style"]} onClick={() => {
                        ...
                        {styleRes ? 
                        styleRes: "Lowest To Highest Number"}
                        {styleIsOpen ? <img width="20px" height="20px" src={arrow} alt="img" />: <img className={classes["arrow-down"]} width="20px" height="20px" src={arrow} alt="img" />} 
                    </div>
                    {styleIsOpen ? 
                    <div className={classes["element-style"]}>
                        <div onClick={(e) => handleSelect(e.target.textContent)}>Lowest To Highest Number</div>
                        <div onClick={(e) => handleSelect(e.target.textContent)}>Highest To Lowest Number</div>
